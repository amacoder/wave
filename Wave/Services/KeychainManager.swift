...
class KeychainManager {
    ...
    func saveGroqAPIKey(_ apiKey: String) -> Bool {
        saveSecureValue(apiKey, forKey: groqKeyAccount)
    }

    func getGroqAPIKey() -> String? {
        getSecureValue(forKey: groqKeyAccount)
    }

    func deleteGroqAPIKey() -> Bool {
        deleteSecureValue(forKey: groqKeyAccount)
    }
