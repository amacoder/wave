...
```
Wave/
├── WaveApp.swift          # App entry point, AppState model
...
1. Open `Wave.xcodeproj` in Xcode 15+
2. Select your development team for signing
3. Build and run (⌘R)

### For Release
```bash
xcodebuild -scheme Wave -configuration Release archive
```
